...
pais(vaticano, 836, italiano, 84.2, 0.44, 0.44, 0).
...
pais(monaco, 38964, frances, 89, 2, 7.18, 1.52).
...
pais(nauru, 10084, ingles, 63.9, 21, 0.11, 2.90).
...
pais(macedonia_do_norte, 1836713, macedonio, 73, 25713, 12.55, 1.43).
...
pais(palestina, 5166000, arabe, 73.2, 6032, 17.42, 3.44).
...
pais(tuvalu, 11646, tuvaluano, 60, 26, 0.04, 2.80).
